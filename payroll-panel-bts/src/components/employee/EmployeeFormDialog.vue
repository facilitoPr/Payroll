<template>
  ...
  >
    <q-card class="employee-dialog column no-wrap">
      <q-inner-loading
        :showing="loading || dataLoading"
        :label="
          loading ? 'Guardando empleado...' : 'Cargando datos del formulario...'
        "
      ...
      <q-card-section class="employee-dialog-body">
        ...
        <div class="form-section">
          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 col-md-4">
              <div class="field-label required">Cédula</div>
              <q-input
                v-model="localForm.idNumber"
                outlined
                dense
                rounded
                color="primary"
        ...
        <div class="form-section">
          <div class="form-section-header">
            <div>
              ...
              <div class="form-section-subtitle">
                Compañía, departamento, puesto y proyecto asignado.
              </div>
            </div>
          </div>
          ...
          <div class="row q-col-gutter-md">
            <div class="col-12 col-md-3">
              <div class="field-label required">Compañía</div>
              <q-select
            ...
            <div class="col-12 col-md-3">
              ...
              <q-select
                ...
                emit-value
                map-options
                @update:model-value="handleJobPositionChange"
              >
                <template #no-option>
                  <q-item>
                    <q-item-section class="text-grey">
            ...
            <div class="row q-col-gutter-md items-center">
              <div class="col-12 col-md-8">
                ...
                >
                  ...
                  <template #hint> Tamaño recomendado: 400×400. </template>
                </q-file>
      ...
      <q-card-actions align="right" class="dialog-actions">
        ...
        <q-btn
          ...
          class="dialog-action-btn"
          :loading="loading"
          :disable="saveDisabled || dataLoading"
          @click="emit('save')"
        />
      </q-card-actions>
    </q-card>
...
const saveDisabled = computed(() => {
  return (
    ...
    !localForm.value.idNumber ||
    !localForm.value.hiringDate ||
    props.companySelected == null ||
...
const handleCompanyChange = (value) => {
  emit("update:companySelected", value);
  emit("company-change", value);
};

const handleJobPositionChange = (value) => {
  emit("update:jobPositionSelected", value);
  emit("job-position-change", value);
};
</script>
