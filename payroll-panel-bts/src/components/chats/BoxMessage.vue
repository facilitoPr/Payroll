<template>
  <div ref="messageContainer" class="message-container row q-px-xl items-center" @scroll="handleScroll">
    <div class="col-12 q-mt-md" v-for="(item, index) in message" :key="index" @mouseover="hoverIndex = index"
      @mouseleave="hoverIndex = null">
      <div class="row" v-if="item.position == 1">
        <div class="col-9 row" v-if="!loading">
          <div class="row col-12 justify-start items-center">
            ...
            <div class="col-auto">
              <MenuOptionChat v-if="hoverIndex === index" :index="index" :item="item" @deleteMessage="deleteMessage"
          ...
          <div class="col-auto">
            <div class="left q-px-sm q-py-sm">
              ...
              <small v-if="item.isEdited" style="font-size: 9px; color: gray">editado</small>
            </div>
            <div class="">
      ...
      <div class="row justify-end" v-if="item.position == 2">
        <div class="col-9 justify-end row" v-if="!loading">
          ...
          <div class="col-auto">
            <div class="right q-px-sm q-py-sm bg-primary text-white">
              ...
              <small v-if="item.isEdited" style="font-size: 9px; color: white">editado</small>
            </div>
...
// Observa cambios en el array de mensajes
watch(
  () => props.message,
...
onMounted(async () => {
  nextTick(() => {
    ...
    // nextTick()
    // allMessage.value = await props.message
    // console.log( allMessage.value, " props.message")
    scrollToBottom();
    // setTimeout(() => {
    //   loading.value = false;
    // }, 1000);
